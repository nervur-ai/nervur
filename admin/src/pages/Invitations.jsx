                    ...
                    <div className="flex items-center gap-3 min-w-0">
                      ...
                      <div className="min-w-0">
                        {inv.inviterDisplayName && (
                          <h3 className="font-semibold text-gray-900 truncate">{inv.inviterDisplayName}</h3>
                        )}
                        <p
                          className={`font-mono truncate ${inv.inviterDisplayName ? 'text-xs text-gray-400 mt-0.5' : 'font-semibold text-gray-900'}`}
                        >
                          {inv.inviter || 'Unknown'}
                        </p>
                        {!inv.inviterDisplayName && <p className="text-xs text-gray-400 mt-0.5">Direct message</p>}
                        {inv.reason && (
                  ...
                  <div className="flex items-start gap-3 min-w-0">
                    ...
                    <div className="min-w-0">
                      <div className="flex items-center gap-2">
                        <h3 className="font-semibold text-gray-900 truncate">{inv.roomName || 'Unnamed Room'}</h3>
                      ...
                      <p className="text-xs text-gray-400 mt-1 truncate">
                        {inv.inviter && (
                          <>
                            invited by{' '}
                            {inv.inviterDisplayName && <span className="text-gray-500">{inv.inviterDisplayName} </span>}
                            <span className="font-mono text-gray-500">{inv.inviter}</span>
                          </>
                        )}
                        {inv.creator && inv.creator !== inv.inviter && (
                          <>
                            {inv.inviter && <span className="mx-1.5">&middot;</span>}created by{' '}
                            <span className="font-mono">{inv.creator}</span>
                          </>
                        )}
                      </p>
                    </div>
