  ...
  return (
    <div>
      ...
      <div className="max-w-3xl space-y-6">
        {/* ── Homeserver Info (remote only — local has dedicated Homeserver > Settings page) ── */}
        {!isLocal && (
          <>
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between text-sm">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-gray-600">Server endpoint</span>
                ...
                <div className="grid grid-cols-2 gap-x-8 gap-y-3 text-sm">
                  {serverDetails.server && (
                    <div>
                      ...
                      <p className="font-medium text-gray-900">
                        ...
                        {serverDetails.server.version && (
                          <span className="text-gray-500 ml-1">{serverDetails.server.version}</span>
                        )}
                      </p>
                    </div>
                  )}
                  <div>
                    ...
                    <p className="font-mono font-semibold text-gray-900">
                      {sortVersions(serverDetails.versions).at(-1)}
                    </p>
                  </div>
                  <div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              {resetStep > 0 && !resetting && (
                <button onClick={() => setResetStep(0)} className="ml-3 text-sm text-gray-500 hover:text-gray-700">
                  Cancel
                </button>
              )}
            </div>
                ...
                >
                  {factoryResetting
                    ...
                    : factoryStep === 0
                      ? 'Factory Reset'
                      : factoryStep === 1
                        ? 'Are you sure? This deletes ALL data'
                        : 'Final confirmation — destroy everything'}
                </button>
                {factoryStep > 0 && !factoryResetting && (
                  <button onClick={() => setFactoryStep(0)} className="ml-3 text-sm text-gray-500 hover:text-gray-700">
                    Cancel
                  </button>
                )}
              </div>
